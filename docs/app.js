              ...
              return {
                  ...
                  componentDidMount: function __do() {
                      ...
                      return Lib_WebSocket.onMsg(props1.ws)(function (x) {
                          ...
                          throw new Error("Failed pattern match at App.Driver (line 72, column 28 - line 76, column 31): " + [ v.constructor.name ]);
                      })((function () {
...
(function($PS) {
  ...
  var riderClass = (function () {
      ...
      var tpeText = function (v) {
          ...
          throw new Error("Failed pattern match at App.Rider (line 97, column 3 - line 97, column 37): " + [ v.constructor.name ]);
      };
      var today = Data_Functor.mapFlipped(Effect.functorEffect)(Control_Bind.bind(Effect.bindEffect)(Data_JSDate.now)(Data_JSDate.toISOString))(Data_String_CodePoints.take(19));
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([ Lib_React.cn("m-2  ") ])([ React_DOM.form([ React_DOM_Props.noValidate(true) ])([ React_DOM.h6([  ])([ React_DOM.text("\u0414\u0430\u043d\u043d\u044b\u0435 \u0432\u043e\u0434\u0438\u0442\u0435\u043b\u044f") ]), React_DOM.div([ Lib_React.cn("form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-4 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("name") ])([ React_DOM.text("\u0418\u043c\u044f") ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("name"), React_DOM_Props.required(true), React_DOM_Props.value(state.name), Lib_React.onChangeValue(function (v) {
              ...
              }) ]), React_DOM.small([ Lib_React.cn("form-text text-muted") ])([ React_DOM.text("\u0412\u0438\u0434\u0435\u043d \u0442\u043e\u043b\u044c\u043a\u043e \u0432\u043e\u0434\u0438\u0442\u0435\u043b\u044e") ]) ]), React_DOM.div([ Lib_React.cn("col-md-4 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("phone") ])([ React_DOM.text("\u041f\u0440\u043e\u0444\u0435\u0441\u0441\u0438\u044f") ]), React_DOM.select([ Lib_React.cn("custom-select"), React_DOM_Props["_id"]("type"), React_DOM_Props.value((function () {
                  ...
                  throw new Error("Failed pattern match at App.Rider (line 133, column 32 - line 140, column 55): " + [ state.tpe.constructor.name ]);
              ...
              }) ]) ]) ]), React_DOM.div([  ])([ React_DOM.h6([  ])([ React_DOM.text("\u041d\u0430\u0447\u0430\u043b\u043e \u043c\u0430\u0440\u0448\u0440\u0443\u0442\u0430") ]) ]), React_DOM.div([ Lib_React.cn("form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-4 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("cityFrom") ])([ React_DOM.text("\u0413\u043e\u0440\u043e\u0434") ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("cityFrom"), React_DOM_Props.required(true), React_DOM_Props.value(state.from.city), Lib_React.onChangeValue(function (v) {
                  return React.modifyState($$this)(function (s) {
                      return {
                          name: s.name,
                          phone: s.phone,
                  ...
                  throw new Error("Failed pattern match at App.Rider (line 220, column 11 - line 228, column 30): " + [ state.mapQ.constructor.name ]);
              })(), React_DOM.div([ Lib_React.cn("form-group") ])([ React_DOM.div([ Lib_React.cn("form-check") ])([ React_DOM.input([ React_DOM_Props["_type"]("checkbox"), Lib_React.cn("form-check-input"), React_DOM_Props["_id"]("agree_terms") ]), React_DOM.label([ React_DOM_Props.htmlFor("agree_terms"), Lib_React.cn("form-check-label") ])([ React_DOM.text("\u042f \u0441\u043e\u0433\u043b\u0430\u0441\u0435\u043d \u0441 \u0443\u0441\u043b\u043e\u0432\u0438\u044f\u043c\u0438 \u0438 \u043f\u043e\u043b\u043e\u0436\u0435\u043d\u0438\u044f\u043c\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u044f \u0441\u0435\u0440\u0432\u0438\u0441\u0430") ]) ]), React_DOM.div([ Lib_React.cn("form-check") ])([ React_DOM.input([ React_DOM_Props["_type"]("checkbox"), Lib_React.cn("form-check-input"), React_DOM_Props["_id"]("agree_rules") ]), React_DOM.label([ React_DOM_Props.htmlFor("agree_rules"), Lib_React.cn("form-check-label") ])([ React_DOM.text("\u042f \u043e\u0437\u043d\u0430\u043a\u043e\u043c\u0438\u043b\u0441\u044f \u0441 \u043f\u0440\u0430\u0432\u0438\u043b\u0430\u043c\u0438 \u0431\u0435\u0437\u043e\u043f\u0430\u0441\u043d\u043e\u0441\u0442\u0438") ]) ]) ]), React_DOM.div([ Lib_React.cn("alert alert-info col-md-12") ])([ React_DOM.text("\u041f\u0435\u0440\u0435\u0434 \u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435\u043c \u043f\u043e\u0441\u043c\u043e\u0442\u0440\u0438\u0442\u0435 \u043f\u0440\u0435\u0434\u043f\u043e\u043b\u043e\u0433\u0430\u0435\u043c\u044b\u0439 \u043c\u0430\u0440\u0448\u0440\u0443\u0442") ]), React_DOM.button([ Lib_React.cn("btn btn-primary mb-3"), React_DOM_Props["_type"]("button"), React_DOM_Props.onClick(function (v) {
              ...
              return {
                  ...
                  componentDidMount: function __do() {
                      ...
                      return Lib_WebSocket.onMsg(props1.ws)(function (x) {
                          ...
                          throw new Error("Failed pattern match at App.Rider (line 62, column 28 - line 64, column 31): " + [ v.constructor.name ]);
                      })((function () {
...
(function($PS) {
  ...
  var tabText = function (v) {
      ...
      throw new Error("Failed pattern match at App.Add (line 44, column 1 - line 44, column 25): " + [ v.constructor.name ]);
  };
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.ul([ Lib_React.cn("nav nav-tabs") ])(Data_Functor.map(Data_Functor.functorArray)(function (t) {
                  ...
                  }) ])([ React_DOM.text(tabText(t)) ]) ]);
              })([ AddD.value, AddR.value ])), (function () {
                  if (state.tab instanceof AddD) {
                      return React.createLeafElement()(App_Driver.driverClass)({
                          ws: props.ws
                      });
                  };
                  if (state.tab instanceof AddR) {
                      return React.createLeafElement()(App_Rider.riderClass)({
                          ws: props.ws
                      });
                  };
                  throw new Error("Failed pattern match at App.Add (line 72, column 9 - line 74, column 62): " + [ state.tab.constructor.name ]);
              })() ]);
          };
      };
...
(function($PS) {
          ...
          return Control_Applicative.pure(Effect.applicativeEffect)({
              ...
              componentDidMount: function __do() {
                  ...
                  return Lib_WebSocket.onMsg(props.ws)(function (x) {
                      ...
                      throw new Error("Failed pattern match at App (line 56, column 28 - line 59, column 31): " + [ v.constructor.name ]);
                  })((function () {
  ...
  var view = (function () {
      ...
      return function __do() {
          ...
          var ws = Lib_WebSocket.create("ridehub.city:8443")();
          ...
          return function (user) {
              ...
              throw new Error("Failed pattern match at App (line 85, column 17 - line 88, column 34): " + [ v.constructor.name ]);
          };
      };
  })();
