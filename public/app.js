      ...
      return function (d) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
              ...
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  ...
                  throw new Error("Failed pattern match at Ajax (line 30, column 10 - line 32, column 77): " + [ resp.constructor.name ]);
              })());
          });
      };
  };
          ...
          return function (failure) {
              return function (success) {
                  var f = function (v) {
                      ...
                      throw new Error("Failed pattern match at Ajax (line 37, column 5 - line 37, column 64): " + [ v.constructor.name ]);
                  };
  ...
  var get = function (url) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.request({
          ...
          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
              ...
              throw new Error("Failed pattern match at Ajax (line 45, column 10 - line 48, column 106): " + [ resp.constructor.name ]);
          })());
      });
  };
      ...
      return function (failure) {
          return function (success) {
              var f = function (v) {
                  ...
                  throw new Error("Failed pattern match at Ajax (line 53, column 5 - line 53, column 60): " + [ v.constructor.name ]);
              };
