...
(function($PS) {
  ...
  var exports = $PS["Api"];
  var Data_Eq = $PS["Data.Eq"];                      
  var SubwayWaypoint = (function () {
      function SubwayWaypoint() {

      };
      SubwayWaypoint.value = new SubwayWaypoint();
      return SubwayWaypoint;
  })();
  var BusStationWaypoint = (function () {
      function BusStationWaypoint() {

      };
      BusStationWaypoint.value = new BusStationWaypoint();
      return BusStationWaypoint;
  })();
  var AirportWaypoint = (function () {
      function AirportWaypoint() {

      };
      AirportWaypoint.value = new AirportWaypoint();
      return AirportWaypoint;
  })();
  var RouteWaypoint = (function () {
      function RouteWaypoint() {

      };
      RouteWaypoint.value = new RouteWaypoint();
      return RouteWaypoint;
  })();
  var StreetAddressWaypoint = (function () {
      function StreetAddressWaypoint() {

      };
      StreetAddressWaypoint.value = new StreetAddressWaypoint();
      return StreetAddressWaypoint;
  })();
  var LocalityWaypoint = (function () {
      function LocalityWaypoint() {

      };
      LocalityWaypoint.value = new LocalityWaypoint();
      return LocalityWaypoint;
  })();
  var ShoppingMallWaypoint = (function () {
      function ShoppingMallWaypoint() {

      };
      ShoppingMallWaypoint.value = new ShoppingMallWaypoint();
      return ShoppingMallWaypoint;
  })();
  var PointOfInterest = (function () {
      function PointOfInterest() {

      };
      PointOfInterest.value = new PointOfInterest();
      return PointOfInterest;
  })();
  var UnknownWaypoint = (function () {
      function UnknownWaypoint() {

      };
      UnknownWaypoint.value = new UnknownWaypoint();
  ...
  exports["SubwayWaypoint"] = SubwayWaypoint;
  exports["BusStationWaypoint"] = BusStationWaypoint;
  exports["AirportWaypoint"] = AirportWaypoint;
  exports["RouteWaypoint"] = RouteWaypoint;
  exports["StreetAddressWaypoint"] = StreetAddressWaypoint;
  exports["LocalityWaypoint"] = LocalityWaypoint;
  exports["ShoppingMallWaypoint"] = ShoppingMallWaypoint;
  exports["PointOfInterest"] = PointOfInterest;
  exports["UnknownWaypoint"] = UnknownWaypoint;
...
(function($PS) {
  ...
  var Data_Either = $PS["Data.Either"];
  var Unsafe_Coerce = $PS["Unsafe.Coerce"];                
  var wrap = Unsafe_Coerce.unsafeCoerce;
  var unwrap = Unsafe_Coerce.unsafeCoerce;
...
(function($PS) {
  ...
  var SimpleLogin = (function () {
      function SimpleLogin(value0) {
          this.value0 = value0;
      };
      SimpleLogin.create = function (value0) {
          return new SimpleLogin(value0);
      };
      return SimpleLogin;
  })();
  ...
  var GetAutocomplete = (function () {
      function GetAutocomplete(value0) {
          this.value0 = value0;
      };
      GetAutocomplete.create = function (value0) {
          return new GetAutocomplete(value0);
      };
      return GetAutocomplete;
  })();
  var GetDirections = (function () {
      function GetDirections(value0) {
          this.value0 = value0;
      };
      GetDirections.create = function (value0) {
          return new GetDirections(value0);
      };
  ...
  var encodeSubwayWaypoint = Proto_Encode.unsignedVarint32(0);
  var encodeStreetAddressWaypoint = Proto_Encode.unsignedVarint32(0);
  var encodeSimpleLogin = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(10), Proto_Encode.string(msg.f1), Proto_Encode.unsignedVarint32(18), Proto_Encode.string(msg.f2) ]);
      return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
  };
  var encodeShoppingMallWaypoint = Proto_Encode.unsignedVarint32(0);
  var encodeRouteWaypoint = Proto_Encode.unsignedVarint32(0);
  var encodeRegular = Proto_Encode.unsignedVarint32(0);
  var encodePolice = Proto_Encode.unsignedVarint32(0);
  var encodePointOfInterest = Proto_Encode.unsignedVarint32(0);
  var encodePing = Proto_Encode.unsignedVarint32(0);
  var encodeMedical = Proto_Encode.unsignedVarint32(0);
  var encodeLogout = Proto_Encode.unsignedVarint32(0);
  var encodeLocation = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(9), Proto_Encode["double"](msg.lat), Proto_Encode.unsignedVarint32(17), Proto_Encode["double"](msg.lng) ]);
      return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
  };
  ...
  var encodeGetAutocomplete = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(10), Proto_Encode.string(msg.text), Data_Maybe.fromMaybe(Proto_Uint8Array.fromArray([  ]))(Data_Functor.map(Data_Maybe.functorMaybe)(function (x) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(18), encodeLocation(x) ]);
      })(msg.location)), Proto_Encode.unsignedVarint32(26), Proto_Encode.string(msg.lang) ]);
      return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
  };
  ...
  var encodeBusStationWaypoint = Proto_Encode.unsignedVarint32(0);
  ...
  var encodeWaypointType = function (v) {
      if (v instanceof Api.SubwayWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(10), encodeSubwayWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.BusStationWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(18), encodeBusStationWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.AirportWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(26), encodeAirportWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.RouteWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(34), encodeRouteWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.StreetAddressWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(42), encodeStreetAddressWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.LocalityWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(50), encodeLocalityWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.ShoppingMallWaypoint) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(58), encodeShoppingMallWaypoint ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
      if (v instanceof Api.PointOfInterest) {
          var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(66), encodePointOfInterest ]);
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
      };
  ...
  var encodeWaypoint = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(10), Proto_Encode.string(msg.description), Proto_Encode.unsignedVarint32(18), encodeWaypointType(msg.tpe), Data_Maybe.fromMaybe(Proto_Uint8Array.fromArray([  ]))(Data_Functor.map(Data_Maybe.functorMaybe)(function (x) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(26), Proto_Encode.string(x) ]);
      })(msg.placeId)) ]);
      return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
  };
  var encodeGetDirections = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Uint8Array.concatAll(Data_Array.concatMap(function (x) {
          return [ Proto_Encode.unsignedVarint32(10), encodeWaypoint(x) ];
      })(msg.waypoints)), Proto_Encode.unsignedVarint32(16), Proto_Encode.bigInt(msg.departure), Proto_Encode.unsignedVarint32(26), Proto_Encode.string(msg.lang) ]);
      return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
  };
  ...
  var encodePull = function (v) {
      ...
      if (v instanceof Logout) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(18), encodeLogout ]);
      };
      ...
      if (v instanceof SimpleLogin) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(34), encodeSimpleLogin(v.value0) ]);
      };
      ...
      if (v instanceof GetAutocomplete) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(562), encodeGetAutocomplete(v.value0) ]);
      };
...
(function($PS) {
  ...
  var GetAutocompleteOk = (function () {
      function GetAutocompleteOk(value0) {
          this.value0 = value0;
      };
      GetAutocompleteOk.create = function (value0) {
          return new GetAutocompleteOk(value0);
      };
      return GetAutocompleteOk;
  })();
  var GetDirectionsOk = (function () {
      function GetDirectionsOk(value0) {
          this.value0 = value0;
      };
      GetDirectionsOk.create = function (value0) {
          return new GetDirectionsOk(value0);
      };
  ...
  var decodeSubwayWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodeStreetAddressWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodeShoppingMallWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodeRouteWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodePointOfInterest = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodeLocalityWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodeBusStationWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
                  ...
                  return function (pos1) {
                      if (pos1 < end) {
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v) {
                              ...
                              if (v1 === 6) {
                                  return decodeFieldLoop(end)(Proto_Decode.bigInt(_xs_)(v.pos))(function (val) {
                                      return {
      ...
      return function (pos0) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  if (v1.val.tpe instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
                              username: v1.val.username,
  ...
  var decodeAirportWaypoint = function (_xs_) {
      return function (pos0) {
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Applicative.pure(Data_Either.applicativeEither)({
                  pos: v.pos + v.val | 0,
  ...
  var decodeWaypointType = function (_xs_) {
      return function (pos0) {
          var decode = function (end) {
              return function (v) {
                  return function (pos1) {
                      if (pos1 < end) {
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v1) {
                              var v2 = v1.val >>> 3;
                              if (v2 === 1) {
                                  return decodeFieldLoop(end)(decodeSubwayWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.SubwayWaypoint.value);
                                  });
                              };
                              if (v2 === 2) {
                                  return decodeFieldLoop(end)(decodeBusStationWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.BusStationWaypoint.value);
                                  });
                              };
                              if (v2 === 3) {
                                  return decodeFieldLoop(end)(decodeAirportWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.AirportWaypoint.value);
                                  });
                              };
                              if (v2 === 4) {
                                  return decodeFieldLoop(end)(decodeRouteWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.RouteWaypoint.value);
                                  });
                              };
                              if (v2 === 5) {
                                  return decodeFieldLoop(end)(decodeStreetAddressWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.StreetAddressWaypoint.value);
                                  });
                              };
                              if (v2 === 6) {
                                  return decodeFieldLoop(end)(decodeLocalityWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.LocalityWaypoint.value);
                                  });
                              };
                              if (v2 === 7) {
                                  return decodeFieldLoop(end)(decodeShoppingMallWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.ShoppingMallWaypoint.value);
                                  });
                              };
                              if (v2 === 8) {
                                  return decodeFieldLoop(end)(decodePointOfInterest(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.PointOfInterest.value);
                                  });
                              };
                              if (v2 === 9) {
                                  return decodeFieldLoop(end)(decodeUnknownWaypoint(_xs_)(v1.pos))(function (v3) {
                                      return new Data_Maybe.Just(Api.UnknownWaypoint.value);
                                  });
                              };
                              return decodeFieldLoop(end)(Proto_Decode.skipType(_xs_)(v1.pos)(v1.val & 7))(function (v3) {
                                  return v;
  ...
  var decodeWaypoint = function (_xs_) {
      return function (pos0) {
          var decode = function (end) {
              return function (acc) {
                  return function (pos1) {
                      if (pos1 < end) {
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v) {
                              ...
                              if (v1 === 1) {
                                  return decodeFieldLoop(end)(Proto_Decode.string(_xs_)(v.pos))(function (val) {
                                      return {
                                          description: new Data_Maybe.Just(val),
                                          placeId: acc.placeId,
                                          tpe: acc.tpe
                                      };
                                  });
                              ...
                              if (v1 === 2) {
                                  return decodeFieldLoop(end)(decodeWaypointType(_xs_)(v.pos))(function (val) {
                                      return {
                                          tpe: new Data_Maybe.Just(val),
                              ...
                              if (v1 === 3) {
                                  return decodeFieldLoop(end)(Proto_Decode.string(_xs_)(v.pos))(function (val) {
                                      return {
                                          placeId: new Data_Maybe.Just(val),
                                          description: acc.description,
                                          tpe: acc.tpe
                                      };
                                  });
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  tpe: Data_Maybe.Nothing.value,
                  placeId: Data_Maybe.Nothing.value
              })(v.pos))(function (v1) {
                  if (v1.val.description instanceof Data_Maybe.Just && v1.val.tpe instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
                              description: v1.val.description.value0,
                              tpe: v1.val.tpe.value0,
                              placeId: v1.val.placeId
                          }
                      });
                  };
                  return Data_Either.Left.create(new Proto_Decode.MissingFields("Waypoint"));
              });
          });
      };
  };
  var decodeGetAutocompleteOk = function (_xs_) {
      return function (pos0) {
          var decode = function (end) {
              return function (acc) {
                  return function (pos1) {
                          ...
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v) {
                              ...
                              if (v1 === 1) {
                                  return decodeFieldLoop(end)(decodeWaypoint(_xs_)(v.pos))(function (val) {
                                      return {
                                          predictions: Data_Array.snoc(acc.predictions)(val)
                                      };
                                  });
                              };
                              return decodeFieldLoop(end)(Proto_Decode.skipType(_xs_)(v.pos)(v.val & 7))(function (v2) {
      ...
      return function (pos0) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  return Data_Either.Left.create(new Proto_Decode.MissingFields("Active"));
              });
          });
      };
  };
      ...
      return function (pos0) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  if (v1.val.status instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
  ...
  var decodePush = function (_xs_) {
      ...
      return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(0))(function (v) {
          ...
          if (v1 === 70) {
              return decode(decodeGetAutocompleteOk(_xs_)(v.pos))(GetAutocompleteOk.create);
          };
          if (v1 === 80) {
...
(function($PS) {
  ...
  var send = function (ws) {
      var $44 = Web_Socket_WebSocket.sendArrayBufferView(ws);
      return function ($45) {
          return $44(Proto_Uint8Array.unwrap($45));
      };
  };
  var readMessageEvent = (function () {
      var $46 = Data_Maybe.maybe(Data_Either.Left.create(Data_Array.singleton("Can't get event")))(Data_Either.Right.create);
      return function ($47) {
          return $46(Web_Socket_Event_MessageEvent.fromEvent($47));
      };
  })();
  var readArrayBuffer = Foreign.unsafeReadTagged(Data_Identity.monadIdentity)("ArrayBuffer");
  var parseMessageEvent = function (f) {
      var $48 = Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)((function () {
          var $50 = Data_Functor.map(Data_Functor.functorArray)(Foreign.renderForeignError);
          var $51 = Data_Array.fromFoldable(Data_List_Types.foldableList);
          return function ($52) {
              return $50($51(Data_List_NonEmpty.toList($52)));
          };
      })());
      return function ($49) {
          return $48(Control_Monad_Except.runExcept(f(Web_Socket_Event_MessageEvent.data_($49))));
      };
  };
              ...
              return function (failure) {
                  ...
                  return function __do() {
                      var l = Web_Event_EventTarget.eventListener(function (x) {
                          return Data_Either.either((function () {
                              var $53 = Data_Functor["void"](Effect.functorEffect);
                              return function ($54) {
                                  return $53(failure($54));
                              };
  ...
  var onMsg = function (ws) {
      return function (success) {
          return function (failure) {
              return onMsg$prime(readArrayBuffer)(ws)(function ($55) {
                  return success($foreign.uint8Array($55));
              })(failure);
          };
      };
  };
  ...
  var close = Web_Socket_WebSocket.close;
  ...
  var initWs = function (v) {
      return function __do() {
          ...
          onMsg(st.con)(function (d) {
              ...
              throw new Error("Failed pattern match at Lib.WebSocket (line 89, column 29 - line 93, column 73): " + [ v1.constructor.name ]);
          })((function () {
              var $56 = Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect);
              var $57 = Data_Functor.map(Data_Functor.functorArray)(Effect_Console.error);
              return function ($58) {
                  return $56($57($58));
              };
          })())();
...
})(PS["Proto.BigInt"] = PS["Proto.BigInt"] || {});
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["Proto.BigInt"] = $PS["Proto.BigInt"] || {};
  var exports = $PS["Proto.BigInt"];
  var $foreign = $PS["Proto.BigInt"];
  exports["fromNumber"] = $foreign.fromNumber;
  exports["unsafeToNumber"] = $foreign.unsafeToNumber;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  ...
  var Lib_JS = $PS["Lib.JS"];
  var Lib_React = $PS["Lib.React"];
  var Lib_WebSocket = $PS["Lib.WebSocket"];
  var Proto_BigInt = $PS["Proto.BigInt"];
  var React = $PS["React"];
  var React_DOM = $PS["React.DOM"];
  var React_DOM_Props = $PS["React.DOM.Props"];                
  var driverClass = (function () {
      var updateMap = function ($$this) {
          return function __do() {
              ...
              var origin = Data_Maybe.fromMaybe("")(Lib_JS["encodeURI"](s.from.street + ("+" + (s.from.building + ("+" + s.from.city)))));
              var destination = Data_Maybe.fromMaybe("")(Lib_JS["encodeURI"](s.to.street + ("+" + (s.to.building + ("+" + s.to.city)))));
      ...
      var sendDriver = function ($$this) {
          return function __do() {
              ...
              var driver = new Api_Pull.AddDriver({
                  ...
                  phone: s.phone,
                  carPlate: s.carPlate,
                  date: Proto_BigInt.fromNumber(Data_JSDate.getTime(s.date)),
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.h6([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.text(props.keyText("key.driver_data")) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-5 col-lg-3 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("firstName") ])([ React_DOM.text(props.keyText("key.first_name")) ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("firstName"), React_DOM_Props.required(true), React_DOM_Props.value(state.firstName), Lib_React.onChangeValue(function (v) {
                  ...
                  return React_DOM.div([ Lib_React.cn("form-check") ])([ React_DOM.input([ Lib_React.cn("form-check-input"), React_DOM_Props["_type"]("checkbox"), React_DOM_Props.value(""), React_DOM_Props["_id"](Keys.keyPassengerType(v)), React_DOM_Props.checked(Data_Array.elem(Api.eqPassengerType)(v)(state.types)), React_DOM_Props.onChange(function (v1) {
                      return React.modifyState($$this)(function (v2) {
                          return {
                              ...
                              to: v2.to,
                              types: (function () {
                                  var $39 = Data_Array.elem(Api.eqPassengerType)(v)(state.types);
                                  if ($39) {
                  ...
                  throw new Error("Failed pattern match at App.Driver (line 283, column 9 - line 291, column 28): " + [ state.mapQ.constructor.name ]);
                  ...
                  throw new Error("Failed pattern match at App.Driver (line 303, column 9 - line 305, column 28): " + [ state.error.constructor.name ]);
              })(), (function () {
                  ...
                  throw new Error("Failed pattern match at App.Driver (line 306, column 9 - line 316, column 14): " + [ state.routeId.constructor.name ]);
              })() ]);
          };
      };
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.h6([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.text(props.keyText("key.passenger_data")) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-5 col-lg-3 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("firstName") ])([ React_DOM.text(props.keyText("key.first_name")) ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("firstName"), React_DOM_Props.required(true), React_DOM_Props.value(state.firstName), Lib_React.onChangeValue(function (v) {
                  ...
                  throw new Error("Failed pattern match at App.Rider (line 236, column 9 - line 244, column 28): " + [ state.mapQ.constructor.name ]);
              })(), React_DOM.div([ Lib_React.cn("form-group") ])([ React_DOM.div([ Lib_React.cn("form-check") ])([ React_DOM.input([ React_DOM_Props["_type"]("checkbox"), Lib_React.cn("form-check-input"), React_DOM_Props["_id"]("agree_terms") ]), React_DOM.label([ React_DOM_Props.htmlFor("agree_terms"), Lib_React.cn("form-check-label") ])([ React_DOM.text(props.keyText("key.agree_terms")) ]) ]), React_DOM.div([ Lib_React.cn("form-check") ])([ React_DOM.input([ React_DOM_Props["_type"]("checkbox"), Lib_React.cn("form-check-input"), React_DOM_Props["_id"]("agree_rules") ]), React_DOM.label([ React_DOM_Props.htmlFor("agree_rules"), Lib_React.cn("form-check-label") ])([ React_DOM.text(props.keyText("key.agree_rules")) ]) ]) ]), React_DOM.div([ Lib_React.cn("alert alert-info col-md-12") ])([ React_DOM.text(props.keyText("key.add.hint")) ]), (function () {
                  if (state.routeId instanceof Data_Maybe.Just) {
                      return React_DOM.div([ Lib_React.cn("alert alert-success") ])([ React_DOM.text(props.keyText("key.add.success") + (" " + state.routeId.value0)) ]);
                  };
                  ...
                  throw new Error("Failed pattern match at App.Rider (line 256, column 9 - line 266, column 14): " + [ state.routeId.constructor.name ]);
              })() ]);
          };
      };
      var onMsg = function ($$this) {
          ...
          return function __do() {
              ...
              return {
                  state: {
                      ...
                      date: date,
                      tpe: Data_Maybe.fromMaybe(Api.Medical.value)(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(props.user)(function (v) {
                          return v.tpe;
                      })),
                      from: {
                          country: "\u0423\u043a\u0440\u0430\u0438\u043d\u0430",
...
(function($PS) {
  ...
  var waypointClass = (function () {
      var waypointIcon = function (v) {
          if (v instanceof Api.SubwayWaypoint) {
              return "fas fa-subway fa-lg";
          };
          if (v instanceof Api.BusStationWaypoint) {
              return "fas fa-bus-alt fa-lg";
          };
          if (v instanceof Api.AirportWaypoint) {
          ...
          if (v instanceof Api.StreetAddressWaypoint) {
              return "fas fa-building fa-lg";
          };
          if (v instanceof Api.LocalityWaypoint) {
              return "fas fa-city fa-lg";
          };
          if (v instanceof Api.ShoppingMallWaypoint) {
              return "fas fa-shopping-bag fa-lg";
          };
          if (v instanceof Api.PointOfInterest) {
              return "fas fa-map-marker-alt fa-lg";
          };
          if (v instanceof Api.UnknownWaypoint) {
              return "";
          };
      ...
      var onMsg = function ($$this) {
          return function (v) {
              if (v instanceof Data_Maybe.Just && v.value0 instanceof Api_Push.GetAutocompleteOk) {
                  return function __do() {
                      var s = React.getState($$this)();
                      if (s.focus) {
                          return React.modifyState($$this)(function (v1) {
                              return {
                                  timer: v1.timer,
                                  predictions: v.value0.value0.predictions,
                                  focus: v1.focus,
                                  unsub: v1.unsub
                              };
                          })();
          ...
          return function (v1) {
              if (Data_String_CodePoints.length(v1) > 3) {
                  return function __do() {
                      ...
                      return React.modifyState(v)(function (v3) {
                          return {
                              timer: new Data_Maybe.Just(t),
                              predictions: v3.predictions,
                              focus: v3.focus,
                              unsub: v3.unsub
                          };
                      })();
      ...
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              var state = React.getState($$this)();
              return React_DOM.div([ Lib_React.cn("input-group") ])([ React_DOM.div([ Lib_React.cn("input-group-prepend align-self-center") ])([ React_DOM.i([ Lib_React.cn(props.icon) ])([  ]) ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control ml-2"), React_DOM_Props.required(true), React_DOM_Props.value(props.waypoint.description), Lib_React.onChangeValue(function (v) {
                  return function __do() {
                      props.set({
                          description: v,
                          tpe: props.waypoint.tpe,
                          placeId: props.waypoint.placeId
                      })(false)();
                      return fetchAutocomplete($$this)(v)();
                  };
              }), React_DOM_Props.onFocus(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          timer: v1.timer,
              ...
              }), React_DOM_Props.onBlur(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          timer: v1.timer,
                          predictions: v1.predictions,
                  ...
                  return "";
              })()) ])(Data_Functor.map(Data_Functor.functorArray)(function (prediction) {
                  return React_DOM.a([ Lib_React.cn("dropdown-item"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                      return function __do() {
                          React.modifyState($$this)(function (v1) {
                              return {
                                  timer: v1.timer,
                          ...
                          return props.set(prediction)(true)();
                      };
                  }) ])([ React_DOM.i([ Lib_React.cn(waypointIcon(prediction.tpe)) ])([  ]), React_DOM.span([ Lib_React.cn("ml-1") ])([ React_DOM.text(prediction.description) ]) ]);
              })(state.predictions)) ]);
          };
      };
      return React.component()("Waypoint")(function ($$this) {
          return function __do() {
              var date = Data_JSDate.now();
              var props = React.getProps($$this)();
              return {
                  state: {
                      timer: Data_Maybe.Nothing.value,
                      predictions: [  ],
                      focus: false,
                      unsub: Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit)
                  },
...
(function($PS) {
  ...
  "use strict";
  $PS["Lib.Maps"] = $PS["Lib.Maps"] || {};
  var exports = $PS["Lib.Maps"];
  var $foreign = $PS["Lib.Maps"];
  var Data_Array = $PS["Data.Array"];
  ...
  var Data_String_CodeUnits = $PS["Data.String.CodeUnits"];
  var Effect = $PS["Effect"];                
  var GooglePolyline = function (x) {
      return x;
  };
  var GoogleMap = function (x) {
      return x;
  };
  var setCenter = function (v) {
      return function (location) {
          return $foreign.setCenterImpl(v)(location);
      };
  };                        
  ...
  var decodeFlatList = function (factor) {
      return function (bytes) {
          ...
          var foldRes = Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
              return function (c) {
                  ...
                  return {
                      ...
                      v1: acc.v2,
                      v2: fullCurr,
                      res: Data_Array.snoc(acc.res)(Data_Int.toNumber(fullCurr) / factor)
                  };
              };
          })(init)(bytes);
          return foldRes.res;
  ...
  var decode = function (factor) {
      return function (string) {
          ...
          var foldRes = Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
              return function (loc) {
                  if (acc.lat instanceof Data_Maybe.Just) {
                      return {
                          lat: Data_Maybe.Nothing.value,
                          res: Data_Array.snoc(acc.res)({
                              lat: acc.lat.value0,
                              lng: loc
                          })
                      };
                  };
                  if (acc.lat instanceof Data_Maybe.Nothing) {
                      return {
                          lat: new Data_Maybe.Just(loc),
                          res: acc.res
                      };
                  };
  ...
  var decodeGoogle = decode(googleFactor);
  var createPolyline = function (settings) {
      return Data_Functor.map(Effect.functorEffect)(GooglePolyline)($foreign.createPolylineImpl(settings));
  };
  var createMap = function (id) {
      return function (settings) {
          return Data_Functor.map(Effect.functorEffect)(GoogleMap)($foreign.createMapImpl(id)(settings));
      };
  };
  var attachPolyline = function (v) {
      return function (v1) {
          return $foreign.attachPolylineImpl(v)(v1);
      };
  };
  ...
  exports["detachPolyline"] = detachPolyline;
  exports["getLocation"] = $foreign.getLocation;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["App.Add.Driver"] = $PS["App.Add.Driver"] || {};
  var exports = $PS["App.Add.Driver"];
  var Api = $PS["Api"];
  var Api_Pull = $PS["Api.Pull"];
  var Api_Push = $PS["Api.Push"];
  ...
  var addDriverClass = (function () {
      ...
      var icon = function (v) {
          return function (v1) {
              if (v === 0) {
                  return "far fa-dot-circle fa-lg";
              };
              if (v === v1) {
                  return "fas fa-flag-checkered fa-lg";
              };
              return "far fa-circle fa-lg";
          };
      };
      var fetchRoute = function ($$this) {
          return function __do() {
              var s = React.getState($$this)();
              var p = React.getProps($$this)();
              ...
              if ($36) {
                  ...
                  return Lib_WebSocket.snd(p.ws)(new Api_Pull.GetDirections({
                      waypoints: w,
                      departure: Proto_BigInt.fromNumber(Data_JSDate.getTime(s.date)),
                      lang: p.lang
                  }))();
              };
              return Data_Unit.unit;
      ...
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              var state = React.getState($$this)();
              return React_DOM.div([  ])([ React_DOM.h6([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.text(props.keyText("key.route_data")) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.div([ Lib_React.cn("col-9 col-md-6 col-lg-5 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("date") ])([ React_DOM.text(props.keyText("key.date")) ]), React.createLeafElement()(Lib_Datepicker.datepickerClass)({
                  onChange: function (d) {
                      return React.modifyState($$this)(function (v) {
                          return {
                              waypoints: v.waypoints,
                              date: d,
                              dateDevaiation: v.dateDevaiation,
                              seats: v.seats,
                              location: v.location,
                              map: v.map,
                              routes: v.routes,
                  ...
                  "_id": "date",
                  keyText: props.keyText
              }) ]), React_DOM.div([ Lib_React.cn("col-3 col-md-2 col-lg-1 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("date") ])([ React_DOM.text(props.keyText("key.date.deviation")) ]), React_DOM.input([ React_DOM_Props["_type"]("number"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("seats"), React_DOM_Props.min("0"), React_DOM_Props.max("30"), React_DOM_Props.value("1"), React_DOM_Props.required(true), React_DOM_Props.value(Data_Show.show(Data_Show.showInt)(state.dateDevaiation)), Lib_React.onChangeValueInt(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          waypoints: v1.waypoints,
                          date: v1.date,
              ...
              }) ]) ]) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.div([ Lib_React.cn("col-3 col-md-2 col-lg-1 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("seats") ])([ React_DOM.text(props.keyText("key.seats")) ]), React_DOM.input([ React_DOM_Props["_type"]("number"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("seats"), React_DOM_Props.min("1"), React_DOM_Props.max("5"), React_DOM_Props.value("1"), React_DOM_Props.required(true), React_DOM_Props.value(Data_Show.show(Data_Show.showInt)(state.seats)), Lib_React.onChangeValueInt(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          waypoints: v1.waypoints,
                          date: v1.date,
              ...
              }) ]) ]), React_DOM.div([ Lib_React.cn("col-9 col-md-6 col-lg-6 mb-3") ])([  ]) ]), React_DOM.h6([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.text(props.keyText("key.waypoints.title")) ]), React_DOM.div([  ])(Data_FunctorWithIndex.mapWithIndex(Data_FunctorWithIndex.functorWithIndexArray)(function (i) {
                  return function (a) {
                      return React_DOM.div([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.div([ Lib_React.cn("col-md-8 col-lg-6 mb-3") ])([ React.createLeafElement()(App_Waypoint.waypointClass)({
                          key: Data_Show.show(Data_Show.showInt)(a.n),
                          ws: props.ws,
                          lang: props.lang,
                          keyText: props.keyText,
                          user: props.user,
                          icon: icon(i)(Data_Array.length(state.waypoints) - 1 | 0),
                          location: state.location,
                          waypoint: a.waypoint,
                          set: function (v) {
                              return function (done) {
                                  return React.modifyStateWithCallback($$this)(function (s) {
                                      return {
                                          waypoints: Data_Maybe.fromMaybe(s.waypoints)(Data_Array.modifyAt(i)(function (v2) {
                                              return {
                                                  waypoint: v,
                                                  done: done,
                                                  n: v2.n
                                          ...
                                          date: s.date,
                                          dateDevaiation: s.dateDevaiation,
                                          seats: s.seats,
                                          location: s.location,
                                          map: s.map,
                                          routes: s.routes,
                          ...
                          remove: React.modifyStateWithCallback($$this)(function (s) {
                              return {
                                  waypoints: Data_Maybe.fromMaybe(s.waypoints)(Data_Array.deleteAt(i)(s.waypoints)),
                                  date: s.date,
                                  dateDevaiation: s.dateDevaiation,
                                  seats: s.seats,
                                  location: s.location,
              ...
              })(state.waypoints)), React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.button([ Lib_React.cn("btn btn-outline-secondary"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                  return React.modifyState($$this)(function (s) {
                      var max = Data_Maybe.fromMaybe(0)(Data_Foldable.maximum(Data_Ord.ordInt)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                          return v1.n;
                      })(s.waypoints)));
                      return {
                          waypoints: Data_Array.snoc(s.waypoints)({
                              waypoint: defaultWaypoint,
                              done: false,
                              n: max + 1 | 0
                          }),
                          date: s.date,
      ...
      return React.component()("AddDriver")(function ($$this) {
          return function __do() {
              var date = Data_JSDate.now();
              var props = React.getProps($$this)();
              return {
                  ...
                  componentDidMount: function __do() {
                      var unsub = Lib_WebSocket.sub(props.ws)(onMsg($$this))();
                      var map = Lib_Maps.createMap("div-map")({
                          center: {
                              lat: 50.45,
                              lng: 30.5235
                          },
                      ...
                      return Lib_Maps.getLocation(function (lat) {
                          return function (lng) {
                              var location = {
                                  lat: lat,
                                  lng: lng
  ...
  exports["addDriverClass"] = addDriverClass;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["App.Add.Rider"] = $PS["App.Add.Rider"] || {};
  var exports = $PS["App.Add.Rider"];
  var Api = $PS["Api"];
  var Api_Pull = $PS["Api.Pull"];
  var Api_Push = $PS["Api.Push"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var addRiderClass = (function () {
      ...
      return React.component()("AddRider")(function ($$this) {
          return function __do() {
              var date = Data_JSDate.now();
              var props = React.getProps($$this)();
              return {
  ...
  exports["addRiderClass"] = addRiderClass;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["App.Add.Menu"] = $PS["App.Add.Menu"] || {};
  var exports = $PS["App.Add.Menu"];
  var App_Add_Driver = $PS["App.Add.Driver"];
  var App_Add_Rider = $PS["App.Add.Rider"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Functor = $PS["Data.Functor"];
  var Lib_React = $PS["Lib.React"];
  var React = $PS["React"];
  ...
  var tabKey = function (v) {
      ...
      throw new Error("Failed pattern match at App.Add.Menu (line 34, column 1 - line 34, column 24): " + [ v.constructor.name ]);
  };
  var eqTab = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof AddDriver && y instanceof AddDriver) {
              return true;
          };
          if (x instanceof AddRider && y instanceof AddRider) {
              return true;
          };
          return false;
      };
  });
  var addMenuClass = (function () {
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              var state = React.getState($$this)();
              ...
              })([ AddDriver.value, AddRider.value ])), (function () {
                  if (state.tab instanceof AddDriver) {
                      return React.createLeafElement()(App_Add_Driver.addDriverClass)(props);
                  };
                  if (state.tab instanceof AddRider) {
                      return React.createLeafElement()(App_Add_Rider.addRiderClass)(props);
                  };
                  throw new Error("Failed pattern match at App.Add.Menu (line 62, column 9 - line 64, column 61): " + [ state.tab.constructor.name ]);
              })() ]);
          };
      };
      return React.component()("AddMenu")(function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              return {
                  state: {
  ...
  exports["addMenuClass"] = addMenuClass;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  ...
  var homeClass = (function () {
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              var state = React.getState($$this)();
              return React_DOM.div([  ])([ React_DOM.div([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.button([ Lib_React.cn("btn btn-primary mb-3"), React_DOM_Props["_type"]("button"), React_DOM_Props.onClick(function (v) {
                  return props.logout;
              }) ])([ React_DOM.text(props.keyText("key.logout")) ]) ]) ]);
          };
      };
      var onMsg = function ($$this) {
          return function (v) {
...
(function($PS) {
  ...
  var post = function (url) {
      return function (d) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.post(Affjax_ResponseFormat.arrayBuffer)(url)(Data_Maybe.Just.create(Affjax_RequestBody.arrayView(d))))(function (resp) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  ...
                  throw new Error("Failed pattern match at Lib.Ajax (line 25, column 10 - line 27, column 77): " + [ resp.constructor.name ]);
              })());
          });
      };
  };
                  ...
                  var f = function (v) {
                      if (v instanceof Data_Either.Left) {
                          return Data_Functor["void"](Effect.functorEffect)(function __do() {
                              var v1 = Effect_Class_Console.errorShow(Effect_Class.monadEffectEffect)(Effect_Exception.showError)(v.value0)();
                              return failure(Data_Show.show(Effect_Exception.showError)(v.value0))();
                          });
                      };
                      if (v instanceof Data_Either.Right && v.value0 instanceof Data_Either.Left) {
                          return Data_Functor["void"](Effect.functorEffect)(function __do() {
                              var v1 = Effect_Class_Console.errorShow(Effect_Class.monadEffectEffect)(Data_Show.showString)(v.value0.value0)();
                      ...
                      throw new Error("Failed pattern match at Lib.Ajax (line 32, column 5 - line 32, column 64): " + [ v.constructor.name ]);
                  };
...
(function($PS) {
  ...
  "use strict";
  $PS["App.Login"] = $PS["App.Login"] || {};
  var exports = $PS["App.Login"];
  var $foreign = $PS["App.Login"];
  var Api_Pull = $PS["Api.Pull"];
  var Api_Push = $PS["Api.Push"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
      ...
      return function (err) {
          return function (ok) {
              return function (user) {
                  var f = function (x) {
                      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Foreign_Keys.keys(Data_Identity.monadIdentity)(x))(function (keys$prime) {
                          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(Data_Functor.map(Data_Functor.functorArray)(function (k) {
                              return Data_Functor.mapFlipped(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Foreign_Index.ix(Foreign_Index.indexableForeign(Data_Identity.monadIdentity))(Foreign_Index.indexString(Data_Identity.monadIdentity))(x)(k))(function (v) {
                              ...
                              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Data_Identity.monadIdentity))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Except_Trans.applicativeExceptT(Data_Identity.monadIdentity))(Data_Array.mapMaybe(function (v) {
                                  ...
                                  if (v2 === "string") {
                                      return Data_Maybe.Just.create(Data_Functor.mapFlipped(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Foreign.readString(Data_Identity.monadIdentity)(v.value1))(function (s) {
                                  ...
                                  if (v2 === "number") {
                                      return Data_Maybe.Just.create(Data_Functor.mapFlipped(Control_Monad_Except_Trans.functorExceptT(Data_Identity.functorIdentity))(Foreign.readNumber(Data_Identity.monadIdentity)(v.value1))(function (n) {
                  ...
                  return function __do() {
                      ...
                      if (v instanceof Data_Either.Right) {
                          return Lib_Ajax.postEff("//ridehub.city/login")(Proto_Uint8Array.unwrap(Api_Pull.encodePull(v.value0)))(function (v1) {
                              ...
                              throw new Error("Failed pattern match at App.Login (line 143, column 15 - line 147, column 25): " + [ v1.constructor.name ]);
                          })();
                      };
                      throw new Error("Failed pattern match at App.Login (line 137, column 3 - line 148, column 8): " + [ v.constructor.name ]);
                  };
              };
          };
      };
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.h6([  ])([ React_DOM.text(props.keyText("key.home.head")) ]) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.span([  ])([ React_DOM.text(props.keyText("key.home.text")) ]) ]), React_DOM.div([ Lib_React.cn((function () {
                  var $34 = Data_Maybe.isJust(props.user);
                  if ($34) {
                      return "d-none";
                  };
                  return "";
                  ...
                  return Data_Monoid.mempty(React.monoidReactElement);
              })(), React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3"), React_DOM_Props["_id"]("login-widget") ])([  ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.div([ Lib_React.cn("alert alert-info") ])([ React_DOM.text(props.keyText("key.home.login.hint")), React_DOM.span([ React_DOM_Props.onClick(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      var $36 = {};
                      for (var $37 in v1) {
                  ...
                  if (state.simpleLogin) {
                      return React_DOM.div([ Lib_React.cn("") ])([ React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.div([ Lib_React.cn("col-md-6 col-lg-4 mb-3") ])([ React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("f1"), React_DOM_Props.value(state.f1), Lib_React.onChangeValue(function (v) {
                          return React.modifyState($$this)(function (v1) {
                              var $40 = {};
                              for (var $41 in v1) {
                      ...
                      }), React_DOM_Props.placeholder("1") ]) ]) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.div([ Lib_React.cn("col-md-6 col-lg-4 mb-3") ])([ React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("f2"), React_DOM_Props.value(state.f2), Lib_React.onChangeValue(function (v) {
                          return React.modifyState($$this)(function (v1) {
                              var $43 = {};
                              for (var $44 in v1) {
                      ...
                      }), React_DOM_Props.placeholder("2") ]) ]) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center mb-3") ])([ React_DOM.button([ Lib_React.cn("btn btn-primary mb-3"), React_DOM_Props["_type"]("button"), React_DOM_Props.onClick(function (v) {
                          return Lib_Ajax.postEff("//ridehub.city/login2")(Proto_Uint8Array.unwrap(Api_Pull.encodePull(new Api_Pull.SimpleLogin({
                              f1: state.f1,
                              f2: state.f2
                          }))))(function (v1) {
                              return props.err;
          ...
          return function __do() {
              ...
              return {
                  ...
                  componentDidMount: function __do() {
                      ...
                      throw new Error("Failed pattern match at App.Login (line 59, column 9 - line 65, column 30): " + [ p.user.constructor.name ]);
                  }
              };
          };
      });
      ...
      var driversList = function ($$this) {
          return function __do() {
              ...
              return Data_Functor.map(Effect.functorEffect)(React_DOM.div([ Lib_React.cn("list-group d-flex flex-column justify-content-center") ]))(Data_Functor.map(Effect.functorEffect)(Data_Array.catMaybes)(Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(function (di) {
                  return function __do() {
                      var t = Lib_Datepicker.toLocaleTimeString(Data_JSDate.fromTime(Proto_BigInt.unsafeToNumber(di.date)))();
      ...
      var passengersList = function ($$this) {
          return function __do() {
              ...
              return Data_Functor.map(Effect.functorEffect)(React_DOM.div([ Lib_React.cn("list-group d-flex flex-column justify-content-center") ]))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Functor.map(Data_Functor.functorArray)(function (pi) {
                  return function __do() {
                      var t = Lib_Datepicker.toLocaleTimeString(Data_JSDate.fromTime(Proto_BigInt.unsafeToNumber(pi.date)))();
...
(function($PS) {
  ...
  var App_Add_Menu = $PS["App.Add.Menu"];
  var App_Home = $PS["App.Home"];
  var App_Login = $PS["App.Login"];
  ...
  var showUserName = function (userData) {
      var items = [ Data_String_Common.trim(Data_Maybe.fromMaybe("")(userData.username)), Data_String_Common.trim(Data_Maybe.fromMaybe("")(userData.firstName) + (" " + Data_Maybe.fromMaybe("")(userData.lastName))) ];
      return Data_Maybe.fromMaybe("Anonymous")(Data_Foldable.find(Data_Foldable.foldableArray)((function () {
          var $46 = Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraBoolean);
          return function ($47) {
              return $46(Data_String_Common["null"](Data_String_Common.trim($47)));
          };
      })())(items));
  };
  var showMenuItem = new Data_Show.Show(function (v) {
      ...
      if (v instanceof LoginItem) {
          return "key.menu.login";
      };
      ...
      if (v instanceof AddItem2) {
          return "key.menu.add";
      };
      throw new Error("Failed pattern match at App (line 56, column 1 - line 63, column 36): " + [ v.constructor.name ]);
  });
  var eqMenuItem = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof LoginItem && y instanceof LoginItem) {
              return true;
          };
          ...
          if (x instanceof AddItem2 && y instanceof AddItem2) {
              return true;
          };
          return false;
      };
  ...
  var ordMenuItem = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          if (x instanceof LoginItem) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof LoginItem) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof HomeItem && y instanceof HomeItem) {
              return Data_Ordering.EQ.value;
          ...
          if (x instanceof AddItem) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof AddItem) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof AddItem2 && y instanceof AddItem2) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at App (line 65, column 1 - line 65, column 44): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var appClass = (function () {
      var userIcon = function (v) {
          if (v instanceof Data_Maybe.Just && v.value0.photo instanceof Data_Maybe.Just) {
              return React_DOM.li([  ])([ React_DOM.span([ Lib_React.cn("nav-link p-0") ])([ React_DOM.img([ React_DOM_Props.src(v.value0.photo.value0), Lib_React.cn("rounded-circle z-depth-0 mr-1"), React_DOM_Props.height("35") ]), React_DOM.text(showUserName(v.value0)) ]) ]);
          };
          if (v instanceof Data_Maybe.Just) {
              return React_DOM.li([ Lib_React.cn("nav-item") ])([ React_DOM.span([ Lib_React.cn("nav-link") ])([ React_DOM.text(showUserName(v.value0)) ]) ]);
          };
          if (v instanceof Data_Maybe.Nothing) {
              return React_DOM.li([ Lib_React.cn("nav-item") ])([  ]);
          };
          throw new Error("Failed pattern match at App (line 164, column 3 - line 164, column 45): " + [ v.constructor.name ]);
      };
      ...
      var onMsg = function ($$this) {
          return function (v) {
              if (v instanceof Data_Maybe.Just && (v.value0 instanceof Api_Push.SessionData && v.value0.value0.status instanceof Api_Push.Active)) {
                  return function __do() {
                      var s = React.getState($$this)();
                      if (s.menuItem instanceof LoginItem) {
                          return React.modifyState($$this)(function (v1) {
                              return {
                                  user: new Data_Maybe.Just(v.value0.value0.status.value0.user),
                                  lang: v1.lang,
                                  keyText: v1.keyText,
              ...
              if (v instanceof Data_Maybe.Just && (v.value0 instanceof Api_Push.SessionData && v.value0.value0.status instanceof Api_Push.Guest)) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          user: Data_Maybe.Nothing.value,
                          lang: v1.lang,
                          keyText: v1.keyText,
                          menuItem: LoginItem.value,
                          expandMenu: v1.expandMenu
                      };
                  });
              };
      ...
      var menuItems = function (v) {
          if (v instanceof Data_Maybe.Just) {
              return [ HomeItem.value, AddItem.value, AddItem2.value, ViewItem.value ];
          };
          if (v instanceof Data_Maybe.Nothing) {
              return [ LoginItem.value ];
          };
          throw new Error("Failed pattern match at App (line 160, column 3 - line 160, column 48): " + [ v.constructor.name ]);
      };
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              ...
              return React_DOM.div([  ])([ React_DOM.nav([ Lib_React.cn("navbar navbar-expand-lg navbar-dark bg-primary") ])([ React_DOM.a([ Lib_React.cn("navbar-brand"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
              ...
              }) ])([ React_DOM.text("Ridehub") ]), React_DOM.ul([ Lib_React.cn("navbar-nav ml-auto nav-flex-icons d-lg-none") ])([ userIcon(state.user) ]), React_DOM.button([ Lib_React.cn("navbar-toggler collapsed"), React_DOM_Props["_type"]("button"), React_DOM_Props.onClick(function (v) {
                  return React.modifyState($$this)(function (s) {
                      return {
                          user: s.user,
                          lang: s.lang,
                  ...
                  return React_DOM.li([ Lib_React.cn("nav-item" + (function () {
                      var $43 = Data_Eq.eq(eqMenuItem)(v)(state.menuItem);
                      if ($43) {
                          return " active";
                      };
                      return "";
              ...
              })(menuItems(state.user))), React_DOM.select([ Lib_React.cn("custom-select bg-primary text-white-50"), React_DOM_Props.style({
                  width: "9.5rem"
              ...
              })([ "uk", "ru" ])) ]), React_DOM.ul([ Lib_React.cn("navbar-nav ml-auto nav-flex-icons d-none d-lg-inline") ])([ userIcon(state.user) ]) ]), React_DOM.div([ Lib_React.cn("m-3") ])((function () {
                  if (state.menuItem instanceof Loading) {
                      return [ React_DOM.div([  ])([  ]) ];
                  };
                  if (state.menuItem instanceof LoginItem) {
                      return [ React.createLeafElement()(App_Login.loginClass)({
                          "await": Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit),
                          ok: function __do() {
                              Lib_WebSocket.reconnect(props.ws)();
                              return React.modifyState($$this)(function (v) {
                                  return {
                                      user: v.user,
                                      lang: v.lang,
                  ...
                  if (state.menuItem instanceof HomeItem) {
                      return [ React.createLeafElement()(App_Home.homeClass)({
                          ...
                          keyText: state.keyText,
                          user: state.user,
                          logout: function __do() {
                              Lib_WebSocket.snd(props.ws)(Api_Pull.Logout.value)();
                              return React.modifyState($$this)(function (v) {
                                  return {
                                      user: Data_Maybe.Nothing.value,
                                      lang: v.lang,
                  ...
                  if (state.menuItem instanceof AddItem) {
                      return [ React.createLeafElement()(App_Add_Menu.addMenuClass)({
                          ws: props.ws,
                          lang: state.lang,
                          keyText: state.keyText,
                          user: state.user
                  ...
                  if (state.menuItem instanceof AddItem2) {
                  ...
                  throw new Error("Failed pattern match at App (line 132, column 27 - line 157, column 26): " + [ state.menuItem.constructor.name ]);
              })()) ]);
          };
      };
