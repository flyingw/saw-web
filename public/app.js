...
(function($PS) {
  ...
  var GetGeolocation = (function () {
      function GetGeolocation(value0) {
          this.value0 = value0;
      };
      GetGeolocation.create = function (value0) {
          return new GetGeolocation(value0);
      };
  ...
  var encodeTelegramData = function (v) {
      ...
      throw new Error("Failed pattern match at Api.Pull (line 81, column 1 - line 81, column 49): " + [ v.constructor.name ]);
  };
  ...
  var encodeGetGeolocation = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(10), Proto_Encode.string(msg.text) ]);
      return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(Proto_Uint8Array.length(xs)), xs ]);
  };
  ...
  var encodeCoordinates = function (msg) {
  ...
  var encodeGetAutocomplete = function (msg) {
      var xs = Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(10), Proto_Encode.string(msg.text), Data_Maybe.fromMaybe(Proto_Uint8Array.fromArray([  ]))(Data_Functor.map(Data_Maybe.functorMaybe)(function (x) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(18), encodeCoordinates(x) ]);
  ...
  var encodePassengerType = function (v) {
      ...
      throw new Error("Failed pattern match at Api.Pull (line 152, column 1 - line 152, column 51): " + [ v.constructor.name ]);
  };
  ...
  var encodePull = function (v) {
      ...
      if (v instanceof GetGeolocation) {
          return Proto_Uint8Array.concatAll([ Proto_Encode.unsignedVarint32(642), encodeGetGeolocation(v.value0) ]);
      };
      throw new Error("Failed pattern match at Api.Pull (line 54, column 1 - line 54, column 33): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var AutocompleteOk = (function () {
      function AutocompleteOk(value0) {
          this.value0 = value0;
      };
      AutocompleteOk.create = function (value0) {
          return new AutocompleteOk(value0);
      };
      return AutocompleteOk;
  })();
  var GeolocationOk = (function () {
      function GeolocationOk(value0) {
          this.value0 = value0;
      };
      GeolocationOk.create = function (value0) {
          return new GeolocationOk(value0);
      };
  ...
  var decodeCoordinates = function (_xs_) {
      return function (pos0) {
          var decode = function (end) {
              return function (acc) {
                  return function (pos1) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  return Data_Either.Left.create(new Proto_Decode.MissingFields("Coordinates"));
              });
          });
      };
  };
  var decodeGeolocationOk = function (_xs_) {
      return function (pos0) {
          var decode = function (end) {
              return function (acc) {
                  return function (pos1) {
                      if (pos1 < end) {
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v) {
                              var v1 = v.val >>> 3;
                              if (v1 === 1) {
                                  return decodeFieldLoop(end)(decodeCoordinates(_xs_)(v.pos))(function (val) {
                                      return {
                                          coordinates: new Data_Maybe.Just(val)
                                      };
                                  });
                              };
                              return decodeFieldLoop(end)(Proto_Decode.skipType(_xs_)(v.pos)(v.val & 7))(function (v2) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  coordinates: Data_Maybe.Nothing.value
              })(v.pos))(function (v1) {
                  if (v1.val.coordinates instanceof Data_Maybe.Just) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
                              coordinates: v1.val.coordinates.value0
                          }
                      });
                  };
                  return Data_Either.Left.create(new Proto_Decode.MissingFields("GeolocationOk"));
              });
          });
      };
  };
          ...
          var decode = function (end) {
              return function (v) {
                  return function (pos1) {
                      ...
                      throw new Error("Failed pattern match at Api.Push (line 213, column 5 - line 213, column 159): " + [ end.constructor.name, v.constructor.name, pos1.constructor.name ]);
                  };
              };
          };
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
          ...
          var decode = function (end) {
              return function (v) {
                  return function (pos1) {
                      ...
                      throw new Error("Failed pattern match at Api.Push (line 483, column 5 - line 483, column 156): " + [ end.constructor.name, v.constructor.name, pos1.constructor.name ]);
                  };
              };
          };
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
      ...
      return function (pos0) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  raw: Data_Maybe.Nothing.value,
                  tpe: Data_Maybe.Nothing.value
              })(v.pos))(function (v1) {
                  if (v1.val.description instanceof Data_Maybe.Just && (v1.val.raw instanceof Data_Maybe.Just && v1.val.tpe instanceof Data_Maybe.Just)) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
                              description: v1.val.description.value0,
                              raw: v1.val.raw.value0,
                              tpe: v1.val.tpe.value0
                          }
                      });
                  };
  ...
  var decodeAutocompleteOk = function (_xs_) {
      return function (pos0) {
          var decode = function (end) {
              return function (acc) {
                  return function (pos1) {
                  ...
                  return function (pos1) {
                      if (pos1 < end) {
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v1) {
                              var v2 = v1.val >>> 3;
                              if (v2 === 1) {
                                  return decodeFieldLoop(end)(decodeActive(_xs_)(v1.pos))(function ($635) {
                                      return Data_Maybe.Just.create(Active.create($635));
                                  });
                              };
                              if (v2 === 2) {
                      ...
                      throw new Error("Failed pattern match at Api.Push (line 160, column 5 - line 160, column 150): " + [ end.constructor.name, v.constructor.name, pos1.constructor.name ]);
                  };
              };
          };
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
  ...
  var decodePush = function (_xs_) {
      ...
      return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(0))(function (v) {
          ...
          if (v1 === 71) {
              return decode(decodeAutocompleteOk(_xs_)(v.pos))(AutocompleteOk.create);
          };
          if (v1 === 81) {
              return decode(decodeGeolocationOk(_xs_)(v.pos))(GeolocationOk.create);
          };
  ...
  exports["AutocompleteOk"] = AutocompleteOk;
...
(function($PS) {
  ...
  var waypointClass = (function () {
      var waypointIcon = function (v) {
          if (v instanceof Api_Push.SubwayWaypoint) {
              return "fas fa-subway fa-lg";
          };
          if (v instanceof Api_Push.BusStationWaypoint) {
              return "fas fa-bus-alt fa-lg";
          };
          if (v instanceof Api_Push.AirportWaypoint) {
              return "fas fa-plane fa-lg";
          };
          if (v instanceof Api_Push.RouteWaypoint) {
              return "";
          };
          if (v instanceof Api_Push.StreetAddressWaypoint) {
              return "fas fa-building fa-lg";
          };
          if (v instanceof Api_Push.LocalityWaypoint) {
              return "fas fa-city fa-lg";
          };
          if (v instanceof Api_Push.ShoppingMallWaypoint) {
              return "fas fa-shopping-bag fa-lg";
          };
          if (v instanceof Api_Push.PointOfInterest) {
              return "fas fa-map-marker-alt fa-lg";
          };
          if (v instanceof Api_Push.UnknownWaypoint) {
              return "";
          };
          throw new Error("Failed pattern match at App.Waypoint (line 121, column 3 - line 121, column 41): " + [ v.constructor.name ]);
      };
      var onMsg = function ($$this) {
          return function (v) {
              if (v instanceof Data_Maybe.Just && v.value0 instanceof Api_Push.AutocompleteOk) {
                  return function __do() {
                      var s = React.getState($$this)();
                      if (s.focus) {
                          return React.modifyState($$this)(function (v1) {
      ...
      var fetchAutocomplete = function (v) {
          return function (v1) {
              return function __do() {
                  ...
                  React.modifyState(v)(function (v3) {
                      return {
                          description: v1,
                  ...
                  if ($24) {
                      ...
                      var t = Effect_Timer.setTimeout(1000)(Lib_WebSocket.snd(p.ws)(new Api_Pull.GetAutocomplete({
                          text: v1,
                          lang: p.lang,
                          location: p.location
                      })))();
      ...
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              var state = React.getState($$this)();
              return React_DOM.div([  ])([ React_DOM.div([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.div([ Lib_React.cn("col-md-8 col-lg-6 mb-3 input-group") ])([ React_DOM.div([ Lib_React.cn("input-group-prepend align-self-center") ])([ React_DOM.i([ Lib_React.cn(props.icon) ])([  ]) ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control ml-2"), React_DOM_Props["_id"]("description"), React_DOM_Props.required(true), React_DOM_Props.value(state.description), Lib_React.onChangeValue(function (v) {
                  ...
                  if (props.removeActive) {
                      return React_DOM.div([ Lib_React.cn("input-group-prepend align-self-center ml-2") ])([ React_DOM.a([ Lib_React.cn("far fa-trash-alt fa-lg"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                          return props.remove;
                      }) ])([  ]) ]);
                  };
                  return Data_Monoid.mempty(React.monoidReactElement);
              })(), React_DOM.div([ Lib_React.cn("dropdown-menu ml-5" + (function () {
  ...
  var addDriverClass = (function () {
      ...
      var icon = function (v) {
          return function (v1) {
              ...
              if (v === v1) {
                  return "far fa-flag-checkered fa-lg";
              };
      ...
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              var state = React.getState($$this)();
              return React_DOM.div([  ])([ React_DOM.h6([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.text(props.keyText("key.waypoints.title")) ]), React_DOM.div([  ])(Data_FunctorWithIndex.mapWithIndex(Data_FunctorWithIndex.functorWithIndexArray)(function (i) {
                  return function (a) {
                      return React.createLeafElement()(App_Waypoint.waypointClass)({
                          ...
                          remove: React.modifyState($$this)(function (s) {
                              return {
              ...
              })(state.waypoints)), React_DOM.div([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.a([ Lib_React.cn("btn btn-outline-secondary fas fa-plus fa-lg"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                  return React.modifyState($$this)(function (s) {
                      return {
                  ...
                  if (state.mapUrl instanceof Data_Maybe.Just) {
                      return React_DOM.div([ Lib_React.cn("form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-12 mb-3") ])([ React_DOM.iframe([ React_DOM_Props.width("100%"), React_DOM_Props.height("400"), React_DOM_Props.frameBorder("0"), React_DOM_Props.src(state.mapUrl.value0) ])([  ]) ]) ]);
                  };
                  if (state.mapUrl instanceof Data_Maybe.Nothing) {
                      return Data_Monoid.mempty(React.monoidReactElement);
                  };
                  throw new Error("Failed pattern match at App.Add.Driver (line 111, column 9 - line 119, column 28): " + [ state.mapUrl.constructor.name ]);
              })() ]);
          };
      };
          ...
          return function __do() {
              ...
              return {
                  state: {
                      ...
                      mapUrl: Data_Maybe.Nothing.value,
                      unsub: Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit)
                  },
                  render: render($$this),
                  componentDidMount: function __do() {
                      ...
                      return Lib_Maps.getLocation(function (lat) {
                          return function (lng) {
                              return function __do() {
                                  Effect_Console.logShow(Data_Show.showNumber)(lat)();
                                  return React.modifyState($$this)(function (v) {
                                      return {
                                          waypoints: v.waypoints,
                                          location: new Data_Maybe.Just({
                                              lat: lat,
                                              lng: lng
                                          }),
                                          mapUrl: v.mapUrl,
                  ...
                  return function __do() {
                      ...
                      if (v instanceof Data_Either.Right) {
                          return Lib_Ajax.postEff("//ridehub.city/login")(Proto_Uint8Array.unwrap(Api_Pull.encodePull(v.value0)))(function (v1) {
                              ...
                              throw new Error("Failed pattern match at App.Login (line 98, column 15 - line 102, column 25): " + [ v1.constructor.name ]);
                          })();
                      };
                      throw new Error("Failed pattern match at App.Login (line 92, column 3 - line 103, column 8): " + [ v.constructor.name ]);
                  };
              };
          };
      };
          ...
          return function __do() {
              ...
              return {
                  ...
                  componentDidMount: function __do() {
                      ...
                      throw new Error("Failed pattern match at App.Login (line 51, column 9 - line 57, column 30): " + [ p.user.constructor.name ]);
                  }
              };
          };
      });
...
(function($PS) {
  ...
  var showUserName = function (userData) {
      ...
      return Data_Maybe.fromMaybe("Anonymous")(Data_Foldable.find(Data_Foldable.foldableArray)((function () {
          ...
          return function ($46) {
              return $45(Data_String_Common["null"](Data_String_Common.trim($46)));
          };
      })())(items));
  };
  var showMenuItem = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at App (line 57, column 1 - line 64, column 36): " + [ v.constructor.name ]);
  });
  ...
  var ordMenuItem = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at App (line 66, column 1 - line 66, column 44): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var appClass = (function () {
      var userIcon = function (v) {
          ...
          throw new Error("Failed pattern match at App (line 170, column 3 - line 170, column 45): " + [ v.constructor.name ]);
      };
      ...
      var menuItems = function (v) {
          ...
          throw new Error("Failed pattern match at App (line 166, column 3 - line 166, column 48): " + [ v.constructor.name ]);
      };
      var render = function ($$this) {
          return function __do() {
              var props = React.getProps($$this)();
              ...
              return React_DOM.div([  ])([ React_DOM.nav([ Lib_React.cn("navbar navbar-expand-lg navbar-dark bg-primary") ])([ React_DOM.a([ Lib_React.cn("navbar-brand"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                  ...
                  return React_DOM.li([ Lib_React.cn("nav-item" + (function () {
                      var $42 = Data_Eq.eq(eqMenuItem)(v)(state.menuItem);
                      if ($42) {
                          return " active";
                      };
                      return "";
                  ...
                  throw new Error("Failed pattern match at App (line 134, column 27 - line 163, column 26): " + [ state.menuItem.constructor.name ]);
              })()) ]);
          };
      };
