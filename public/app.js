...
(function($PS) {
          ...
          var decode = function (end) {
              return function (v) {
                  return function (pos1) {
                      ...
                      throw new Error("Failed pattern match at Api.Push (line 201, column 5 - line 201, column 159): " + [ end.constructor.name, v.constructor.name, pos1.constructor.name ]);
                  };
              };
          };
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
      ...
      return function (pos0) {
          ...
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
              return Control_Bind.bind(Data_Either.bindEither)(Control_Monad_Rec_Class.tailRecM3(Control_Monad_Rec_Class.monadRecEither)(decode)(v.pos + v.val | 0)({
                  ...
                  if (v1.val.firstName instanceof Data_Maybe.Just && (v1.val.phone instanceof Data_Maybe.Just && v1.val.tpe instanceof Data_Maybe.Just)) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          pos: v1.pos,
                          val: {
                              firstName: v1.val.firstName.value0,
                  ...
                  return function (pos1) {
                      if (pos1 < end) {
                          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos1))(function (v1) {
                              ...
                              if (v2 === 2) {
                                  return decodeFieldLoop(end)(decodeActive(_xs_)(v1.pos))(function ($477) {
                                      return Data_Maybe.Just.create(Active.create($477));
                                  });
                              };
                              if (v2 === 3) {
                      ...
                      throw new Error("Failed pattern match at Api.Push (line 143, column 5 - line 143, column 150): " + [ end.constructor.name, v.constructor.name, pos1.constructor.name ]);
                  };
              };
          };
          return Control_Bind.bind(Data_Either.bindEither)(Proto_Decode.unsignedVarint32(_xs_)(pos0))(function (v) {
  ...
  exports["AwaitRegister"] = AwaitRegister;
  ...
  var initWs = function (v) {
      return function __do() {
          ...
          onMsg(st.con)(function (d) {
              ...
              throw new Error("Failed pattern match at Lib.WebSocket (line 88, column 29 - line 92, column 73): " + [ v1.constructor.name ]);
          })((function () {
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.h6([ Lib_React.cn("d-flex justify-content-center") ])([ React_DOM.text(props.keyText("key.driver_data")) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-5 col-lg-3 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("firstName") ])([ React_DOM.text(props.keyText("key.first_name")) ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("firstName"), React_DOM_Props.required(true), React_DOM_Props.value(state.firstName), Lib_React.onChangeValue(function (v) {
                  ...
                  throw new Error("Failed pattern match at App.Driver (line 285, column 9 - line 293, column 28): " + [ state.mapQ.constructor.name ]);
                  ...
                  throw new Error("Failed pattern match at App.Driver (line 305, column 9 - line 307, column 28): " + [ state.error.constructor.name ]);
              })(), (function () {
                  ...
                  throw new Error("Failed pattern match at App.Driver (line 308, column 9 - line 318, column 14): " + [ state.routeId.constructor.name ]);
              })() ]);
          };
      };
      var onMsg = function ($$this) {
          ...
          return function __do() {
              ...
              return {
                  state: {
                      ...
                      firstName: Data_Maybe.fromMaybe("")(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(props.user)(function (v) {
                          return v.firstName;
                      })),
                      lastName: Data_Maybe.fromMaybe("")(Control_Bind.bind(Data_Maybe.bindMaybe)(props.user)(function (v) {
                          return v.lastName;
                      })),
                      phone: Data_Maybe.fromMaybe("")(Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(props.user)(function (v) {
                          return v.phone;
                      })),
  ...
  var confirmRegistrationClass = (function () {
              ...
              if (v instanceof Data_Maybe.Just && v.value0 instanceof Api_Push.UserDataOk) {
                  return function __do() {
                      React.modifyState($$this)(function (v1) {
                          return {
                              unsub: v1.unsub,
                              firstName: v.value0.value0.userData.firstName,
                              lastName: Data_Maybe.fromMaybe("")(v.value0.value0.userData.lastName),
                              phone: v.value0.value0.userData.phone,
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.div([ Lib_React.cn("d-flex justify-content-center form-row mb-3") ])([ React_DOM.h6([  ])([ React_DOM.text(props.keyText("key.confirm_registration.head")) ]) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center form-row mb-3") ])([ React_DOM.span([ Lib_React.cn("col-md-10 col-lg-6 mb-3") ])([ React_DOM.text(props.keyText("key.confirm_registration.text")) ]) ]), React_DOM.div([ Lib_React.cn("d-flex justify-content-center form-row") ])([ React_DOM.div([ Lib_React.cn("col-md-5 col-lg-3 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("firstName") ])([ React_DOM.text(props.keyText("key.first_name")), requiredSymbol ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("firstName"), React_DOM_Props.required(true), React_DOM_Props.autoComplete("given-name cc-given-name"), React_DOM_Props.value(state.firstName), Lib_React.onChangeValue(function (v) {
              ...
              }) ]) ]), React_DOM.div([ Lib_React.cn("col-md-5 col-lg-3 mb-3") ])([ React_DOM.label([ React_DOM_Props.htmlFor("lastName") ])([ React_DOM.text(props.keyText("key.last_name")) ]), React_DOM.input([ React_DOM_Props["_type"]("text"), Lib_React.cn("form-control"), React_DOM_Props["_id"]("lastName"), React_DOM_Props.required(true), React_DOM_Props.autoComplete("family-name cc-family-name"), React_DOM_Props.value(state.lastName), Lib_React.onChangeValue(function (v) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          unsub: v1.unsub,
                          firstName: v1.firstName,
                  ...
                  throw new Error("Failed pattern match at App.ConfirmRegistration (line 176, column 11 - line 178, column 31): " + [ state.error.constructor.name ]);
                  ...
                  return function __do() {
                      ...
                      if (v instanceof Data_Either.Right) {
                          return Lib_Ajax.postEff("//ridehub.city/login")(Proto_Uint8Array.unwrap(Api_Pull.encodePull(v.value0)))(function (v1) {
                              ...
                              throw new Error("Failed pattern match at App.Home (line 98, column 15 - line 102, column 25): " + [ v1.constructor.name ]);
                          })();
                      };
                      throw new Error("Failed pattern match at App.Home (line 92, column 3 - line 103, column 8): " + [ v.constructor.name ]);
                  };
              };
          };
      };
          ...
          return function __do() {
              ...
              return {
                  ...
                  componentDidMount: function __do() {
                      ...
                      throw new Error("Failed pattern match at App.Home (line 51, column 9 - line 57, column 30): " + [ p.user.constructor.name ]);
                  }
              };
          };
      });
      ...
      var userIcon = function ($$this) {
          return function __do() {
              ...
              if (state.user instanceof Data_Maybe.Just && state.user.value0.photo instanceof Data_Maybe.Just) {
                  return React_DOM.li([ Lib_React.cn("avatar") ])([ React_DOM.span([ Lib_React.cn("nav-link p-0") ])([ React_DOM.img([ React_DOM_Props.src(state.user.value0.photo.value0), Lib_React.cn("rounded-circle z-depth-0 mr-1"), React_DOM_Props.height("35") ]), React_DOM.text(state.user.value0.firstName + Data_Maybe.fromMaybe("")(state.user.value0.lastName)) ]) ]);
              };
              if (state.user instanceof Data_Maybe.Just) {
                  return React_DOM.li([ Lib_React.cn("nav-item") ])([ React_DOM.span([ Lib_React.cn("nav-link") ])([ React_DOM.text(state.user.value0.firstName + Data_Maybe.fromMaybe("")(state.user.value0.lastName)) ]) ]);
              };
              ...
              throw new Error("Failed pattern match at App (line 158, column 12 - line 175, column 10): " + [ state.user.constructor.name ]);
          };
      };
          ...
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.nav([ Lib_React.cn("navbar navbar-expand-lg navbar-dark bg-primary") ])([ React_DOM.a([ Lib_React.cn("navbar-brand"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                  ...
                  return React_DOM.li([ Lib_React.cn("nav-item" + (function () {
                      var $30 = Data_Eq.eq(eqMenuItem)(v)(state.menuItem);
                      if ($30) {
                          return " active";
                      };
                      return "";
                  ...
                  throw new Error("Failed pattern match at App (line 128, column 27 - line 152, column 24): " + [ state.menuItem.constructor.name ]);
              })()) ]);
          };
      };
      var onMsg = function ($$this) {
          return function (v) {
              if (v instanceof Data_Maybe.Just && (v.value0 instanceof Api_Push.SessionData && v.value0.value0.status instanceof Api_Push.AwaitRegister)) {
                  return React.modifyState($$this)(function (v1) {
                      return {
                          user: v1.user,
                          lang: v1.lang,
              ...
              if (v instanceof Data_Maybe.Just && (v.value0 instanceof Api_Push.SessionData && v.value0.value0.status instanceof Api_Push.Active)) {
                  return function __do() {
                      Effect_Class_Console.infoShow(Effect_Class.monadEffectEffect)(Data_Show.showString)("User")();
                      return React.modifyState($$this)(function (v1) {
                          return {
              ...
              return function __do() {
                  Effect_Class_Console.infoShow(Effect_Class.monadEffectEffect)(Data_Show.showString)("Guest")();
                  return Data_Unit.unit;
              };
          };
      };
