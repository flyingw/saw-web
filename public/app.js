      ...
      return function (d) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.post(Affjax_ResponseFormat.arrayBuffer)(url)(Data_Maybe.Just.create(Affjax_RequestBody.arrayView(d))))(function (resp) {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
                  ...
                  throw new Error("Failed pattern match at Ajax (line 25, column 10 - line 27, column 77): " + [ resp.constructor.name ]);
              })());
          });
      };
  };
          ...
          return function (failure) {
              return function (success) {
                  var f = function (v) {
                      ...
                      throw new Error("Failed pattern match at Ajax (line 32, column 5 - line 32, column 64): " + [ v.constructor.name ]);
                  };
  ...
  var get = function (url) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.string)(url))(function (resp) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
              ...
              throw new Error("Failed pattern match at Ajax (line 40, column 10 - line 44, column 106): " + [ resp.constructor.name ]);
          })());
      });
  };
  var getEff = function (url) {
      return function (success) {
          var f = function (v) {
              ...
              throw new Error("Failed pattern match at Ajax (line 49, column 5 - line 49, column 60): " + [ v.constructor.name ]);
          };
          ...
          return function (ok) {
              return function (user) {
                  ...
                  return function __do() {
                      ...
                      if (v instanceof Data_Either.Right) {
                          return Ajax.postEff("/login")(Proto_Uint8Array.unwrap(Api_Pull.encodePull(v.value0)))(function (v1) {
                              return err;
                          })(function (x) {
...
(function($PS) {
  ...
  var showMenuItem = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at App (line 52, column 1 - line 56, column 33): " + [ v.constructor.name ]);
  });
  ...
  var ordMenuItem = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          throw new Error("Failed pattern match at App (line 58, column 1 - line 58, column 44): " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var appClass = (function () {
      var userIcon = function ($$this) {
          return function __do() {
              ...
              throw new Error("Failed pattern match at App (line 136, column 12 - line 153, column 10): " + [ state.user.constructor.name ]);
          };
      };
      var setLang = function ($$this) {
          return function (lang) {
              return Ajax.getEff("langs/" + (lang + ".js"))(function (v) {
      ...
      var render = function ($$this) {
          return function __do() {
              ...
              return React_DOM.div([  ])([ React_DOM.nav([ Lib_React.cn("navbar navbar-expand-lg navbar-dark bg-primary") ])([ React_DOM.a([ Lib_React.cn("navbar-brand"), React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v) {
                  ...
                  throw new Error("Failed pattern match at App (line 119, column 27 - line 130, column 24): " + [ state.menuItem.constructor.name ]);
              })()) ]);
          };
      };
      var onMsg = function ($$this) {
  ...
  var view = function __do() {
      ...
      var ws = Lib_WebSocket["new"]((function () {
          var $33 = hostname$prime === "localhost";
          if ($33) {
              return "localhost:8001/ws";
          };
          return "ridehub.city/ws";
      })())();
